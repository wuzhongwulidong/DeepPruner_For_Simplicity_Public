...
class UniformSampler(nn.Module):
    ...
    def forward(self, min_disparity, max_disparity, number_of_samples=10.0):
        """
        Uniform Sampler
        ...
        # [B, 1, H, W] + [number_of_samples, 1, 1] --> [B, number_of_samples, H, W]
...
class SpatialTransformer(nn.Module):
    ...
    def forward(self, left_input, right_input, disparity_samples):
        ...
        Description:
                Given the left image features, right image features and teh disparity samples, generates:
                    - Per sample cost as <left_image_features, right_image_features>, <.,.> denotes scalar-product.
                    - Warped righ image features

        Args:
            :left_input: Left Image Features [B, C, H, W]
            :right_input: Right Image Features
            :disparity_samples:  Disparity Samples genearted by PatchMatch  # [B, n, H, W]
        ...
        # [B, H, W] -> [n, B, H, W] -> [B, n, H, W] - [B, n, H, W]=左图的W坐标 - 视差 = 在y图中的W坐标
