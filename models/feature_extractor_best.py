...
class feature_extraction(nn.Module):
    def __init__(self):
        ...
        self.inplanes = 32
        self.firstconv = nn.Sequential(convbn_relu(3, 32, 3, 2, 1, 1),  # H/2
                                       convbn_relu(32, 32, 3, 1, 1, 1),
                                       convbn_relu(32, 32, 3, 1, 1, 1))

        self.layer1 = self._make_layer(BasicBlock, 32, 3, 1, 1, 1)
        self.layer2 = self._make_layer(BasicBlock, 64, 16, 2, 1, 1)  # H/4
        self.layer3 = self._make_layer(BasicBlock, 128, 3, 1, 1, 1)
        self.layer4 = self._make_layer(BasicBlock, 128, 3, 1, 1, 2)  # dilation=2
    ...
    def forward(self, input):
        ...
        output1 = self.layer1(output0)     # H/2
        output_raw = self.layer2(output1)  # H/4
        ...
        # 我的修改，目的是定位作者的预训练模型无法达到EPE=0.86的文体
        # output_branch1 = self.branch1(output_skip)
        ...
        return output_feature, output1  # H/4， H/2
